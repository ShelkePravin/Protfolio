...
return <section id="projects" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-1/3 right-0 w-96 h-96 bg-[#22C55E]/20 opacity-30 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/3 left-0 w-96 h-96 bg-[#22C55E]/20 opacity-30 rounded-full blur-3xl"></div>
            <div className="absolute top-1/2 right-1/3 w-96 h-96 bg-[#22C55E]/10 opacity-30 rounded-full blur-3xl"></div>
        </div>
            ...
            <FadeIn delay={0}>
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#22C55E]/10 border border-[#22C55E]/30 rounded-full mb-6">
                        ...
                        <span className="text-sm text-[#22C55E] font-medium">My Work</span>
                    </div>
                    <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4">
                        Featured Projects
                    </h2>
                    <p className="text-lg text-white/60 max-w-2xl mx-auto">
                        Showing my best work and achievements
                    </p>
                </div>
            </FadeIn>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-8 ">
                            {Array.from({ length: Math.max(0, filteredProjects.length -2)}).map((_, index) => (
                                <button
                                    ...
                                    className={`transition-all duration-300 rounded-full ${index === currentIndex ? 'bg-[#22C55E] w-6 h-2' : 'bg-white/30 w-2 h-2 hover:bg-white/50'}`}
